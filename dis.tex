...
\setlength{\cftfigurenumwidth}%         % Figure has the same 'level' as 'chapter' in the
  {1.75\cftchapternumwidth}                 %   figure list, so make the number spacing the
                                        %   same as for chapters
\setlength{\cfttablenumwidth}%          % Table has the same 'level' as 'chapter' in the
  {1.75\cftchapternumwidth}                 %   table list, so make the number spacing the
                                        %   same as for chapters
...
%\chapter*{Dedication}
%\input{dedication}                   %~Dedication is optional
...
\input{ack}          %<Enter the name of the .tex file containing your
...
\mainmatter
\include{intro}
\include{kid_model}                     %   \include rather than \input for chapters
\include{readout}
\include{blast_data}
\include{carina}
\include{galaxies}
...
\include{appendix}                     %~Insert your appendices here; I recommend to use
