...
The dust is perpetually recycled in the ISM. It is produced in stars, and spread throughout the ISM in the stellar winds produced by dying stars (e.g., red giants, plantary nebulae) as well as by supernovae. Once in the diffuse ISM, the dust becomes incorporated into molecular clouds (MCs), the birth places of stars, where it is cooled to temperatures of $\mathcal{O}(10)$~K. The cold dust then finds its way into the protostellar disks that eventually form into planetary systems. The parent star of the planetary system both destroys and creates new dust, and the cycle repeats itself.
...
N$_{det}$ & 149, 88, 43 & 149, 88, 43 & 139, 88, and 43 & $\sim$1500, 700, 300 \\
Pol. & N & Y & Y & Y \\
