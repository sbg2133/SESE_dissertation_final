...
Power dissipation (W) & $\lesssim$ 65 \\
...
By virtue of flying during the Antarctic summer, the BLAST-TNG gondola is provided with 24~hr sunlight. Its total power budget is $\sim$1~kW. Using a thermal model of the BLAST-TNG gondola (see \citet{gordon2016}) it was determined that each readout slice should dissipate $\lesssim{65}$~W. This places the power-per pixel at $\sim$65~mW/pixel.
...
PHY & 2 & 1.0 \\
DACs & 2 & 0.5 \\
Raspberry Pi 3 & 1 & 2.5 \\ \midrule{}
Total & & 47.8 \\ \dbottomrule{}
\\
\end{tabular}
...
The power dissipation for each of the active IF components is listed in Table~\ref{tab:if power budget}. Their total power dissipation is $\approx$~26.7~W. Adding this value to the $\approx$~48.7~W which are dissipated by the digital electronics (Section~\ref{digital electronics}) gives a total power dissipation of $\approx$~74.5~W. This per-readout slice power dissipation is within acceptable range of the BLAST-TNG power requirement of $\lesssim$65~W per slice.
...
RT LNA & 1 & 5 & 30 & 1.5 \\
Baseband RT Amps & 2 & 5 & 145 & 1.45 \\ \midrule
Total  &  &  &  & 26.7 \\ \dbottomrule{}
\end{tabular}
